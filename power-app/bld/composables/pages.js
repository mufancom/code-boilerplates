...
const PAGE_URL_HELPERS_PATH = Path.join(_constants_1.TEMPLATES_SERVER_HELPERS_DIR, 'page/url.ts.hbs');
const composable = options => {
    ...
    return [
        ...
        core_1.handlebars(Path.join(serverSrc, 'helpers/page/url.ts'), {
